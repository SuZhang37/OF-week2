...
void ofApp::draw(){
    ...
    for(int x=0; x<850; x+=15){
        ofFill();
        ofSetColor(255,211,74);
        ofDrawCircle(200+x,555,2);
    }
    
    ofSetColor(0,0,0);
    ofDrawBitmapString("P I E T  M O N D R I A N", 200,580);
    ofDrawBitmapString("Composition with Red, Blue, and Yellow,1930 (Left)", 200,610);
    ofDrawBitmapString("Tableau I: Lozenge with Four Lines and Gray,1926 (Middle)", 200,630);
    ofDrawBitmapString("Composition II in Red, Blue, and Yellow,1930 (Right)", 200,650);
    ofDrawBitmapString("Animation: Su Zhang", 890,650);
